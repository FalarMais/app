...
export let cadastros = {
  name: "",
};

export let novoCadastro = {
  name: "",
};

export let pesquisarCadastro = {
  name: "",
};
...
if (perfil === "adm") {
  ...
  configuracao = {
    ...
    children: [
      ...
      { to: "/configuracoes/horarios-agenda-turno", name: "Horários / Agenda / Turno" },
      { to: "/configuracoes/fila-atendimentos", name: "Fila de Atendimentos" },
