...
!(function(n) {
        ...
        this.each(function() {
          ...
          if ('table' != this.nodeName.toLowerCase())
            ...
            var f,
              ...
              tt(h),
              h.oClasses),
              g = (P.extend(p, C.ext.classes, r.oClasses),
              l.addClass(p.sTable),
    ...
    n._hungarianMap || i(n),
      P.each(a, function(t, e) {
        (o = n._hungarianMap[t]) === N ||
          (!r && a[o] !== N) ||
          ('o' === o.charAt(0) ? (a[o] || (a[o] = {}), P.extend(!0, a[o], a[t]), w(n[o], a[o], r)) : (a[o] = a[t]));
      });
  }
  function Z(t) {
    var e,
  ...
  function x(t, e, n, a) {
    for (
      var r = t.aoData.length,
        o = P.extend(!0, {}, C.models.oRow, { src: n ? 'dom' : 'data', idx: r }),
  ...
  function yt(t) {
    ...
    if (
      ...
      P(r)
        .children('tr')
        .children('th, td')
        .addClass(l.sHeaderTH),
      P(o)
        .children('tr')
        .children('th, td')
        .addClass(l.sFooterTH),
      null !== o)
    )
    ...
    var a,
        ...
        delete l.data),
      {
        ...
        error: function(t, e, n) {
          ...
          -1 === P.inArray(!0, a) &&
            ('parsererror' == e ? W(r, 0, 'Invalid JSON response', 1) : 4 === t.readyState && W(r, 0, 'Ajax error', 7)),
            D(r, !1);
        }
      });
    (r.oAjaxData = t),
      ...
      for (
        var v = P('<div/>')
          ...
          y = (l && o
            ? b.width(o)
            : l
            ? (b.css('width', 'auto'), b.removeAttr('width'), b.width() < d.clientWidth && f && b.width(d.clientWidth))
            : i
    ...
    for (
      ...
      for (r = (o = c[(s = h[n][(a = 0)])].aDataSort).length; a < r; a++)
        (l = c[(i = o[a])].sType || 'string'),
          ...
          u.push({ src: s, col: i, dir: h[n][1], index: h[n]._idx, type: l, formatter: C.ext.type.order[l + '-pre'] });
    return u;
  }
  function ie(t) {
    var e,
  ...
  function fe(t, e) {
    for (
      var n,
        ...
        l = (i && (n = i.call(t.oInstance, t, e, ot(t, e))), C.ext.type.order[o.sType + '-pre']),
        s = 0,
        u = t.aoData.length;
      s < u;
      s++
  ...
  var Ie = [],
      ...
      if (Array.isArray(t)) for (var n = 0, a = t.length; n < a; n++) B.register(t[n], e);
        ...
        for (var r = t.split('.'), o = Ie, i = 0, l = r.length; i < l; i++) {
          ...
          c || o.push((c = { name: u, val: {}, methodExt: [], propExt: [], type: 'object' })),
            i === l - 1
              ? ((c.val = e), (c.type = 'function' == typeof e ? 'function' : P.isPlainObject(e) ? 'object' : 'other'))
    ...
    (C.tables = C.fnTables = function(e) {
      var t = !1,
        n = (P.isPlainObject(e) && ((t = e.api), (e = e.visible)),
